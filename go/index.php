...
<html>
	...
	<body class="indexbody">
		<iframe src="<?php echo $_GET["path"]?>" height="1200px" width="100%"></iframe>
		<br />
		<div>
			<input type="text" value="http://honbraofficial.github.io/skola/go?path=2p.html" id="linkInput" readonly>
